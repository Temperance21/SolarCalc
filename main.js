...
function addMonths(elem) {
    ...
    function calculateSolar(){
        ...
        var readKWNeeds = minKwNeeds * 1.25;
        console.log(readKWNeeds);

        var realWattNeeds = readKWNeeds * 1000;
        ...
        var feedback="";
        feedback += "<p> Based on your average daily use of "+Math.round(dailyUseKw)+" kWh, you will need to purchase "+panelNeeded+" "+panelName+" solar panel to offset 100% of your electricity bill.</p>";
